...
| [`tests/test-markdown-tables.cjs`](../../tests/test-markdown-tables.cjs)         | Тест выравнивания столбцов GFM-таблиц во всех `*.md`/`*.mdc` проекта — см. [comments-style.md](comments-style.md)                                                                                                                                                                                |
