...
| `list-blank-line-spacing` | Numbered: blank до/после (EOF skip, same-kind skip) и единообразно между соседними num-пунктами блока (вложенные `1.` на любом уровне); bulleted: blank до/после блока |
